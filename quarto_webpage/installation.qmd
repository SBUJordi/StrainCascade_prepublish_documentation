...
## Caveats
-   The installation process writes the necessary paths to the PATH variable (via your shell configuration files and/or conda variable). Generally StrainCascade should be able to handle multiple installations in different conda environments. However, if you encounter issues, please check your `$PATH` variable and make sure that the correct StrainCascade installation is used.